...
public class RVAdapterUpcomingR extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private Context context;
    DAOUpcomingReservations dao;
    User user;
    ArrayList<TimeSlot> items = new ArrayList<>();
    public RVAdapterUpcomingR(Context context, DAOUpcomingReservations dao, User user){
